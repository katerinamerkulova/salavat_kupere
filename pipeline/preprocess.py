...
def etl_data(DATA_DIR="../../data/hackathon_files_for_participants_ozon"):
    ...
    # # df = pd.merge(df, characteristics_df, left_index=True, right_index=True)
    ...
    # df['fuzzywuzzy_ratio_cat4'] = df.progress_apply(
    #     lambda x: fuzz.ratio(
    #         json.loads(x['categories1'])['4'],
    #         json.loads(x['categories2'])['4']
    #     ),
    #     axis=1
    # )
