...
def run_training(DATA_DIR="../../data/hackathon_files_for_participants_ozon"):
    train_df = pd.read_parquet(os.path.join(DATA_DIR,'train_processed_chars_by_cat_color.parquet'))
